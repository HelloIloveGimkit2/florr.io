...
const presets = [
  ...
  (function () {
    ...
    credits_tab.onclick = function () {
      display_panel.innerHTML = `<span><span class="text-muted">Made by</span> <code>@x03</code></span>
      <span><span class="text-muted">Find the script on </span> <code><a href="https://github.com/cat2d2/io">cat2d2/io</a></code></span>`;
      setActiveTab(credits_tab);
    };
  
    const style = document.createElement("style");
    style.textContent = `
  code{font-family:monospace}#panel{font-family:Inter,sans-serif;color:#eee;font-size:16px;display:flex;flex-direction:row;max-width:600px;max-height:400px;width:100%;height:100%;padding:12px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);gap:6px;background:hsla(0,0%,10%,.7);backdrop-filter:blur(7px);-webkit-backdrop-filter:blur(7px);border:1px solid hsla(0,0%,100%,.1);border-radius:8px;z-index:10}.separator{width:1px;height:100%;background-color:hsla(0,0%,100%,.1)}.switch,.switch div{font-size:20px;height:1em;border-radius:1em;cursor:pointer}.switch{display:inline-block;width:2em;background:#323232;margin-right:10px}.button,.tab_button{background:hsla(0,0%,20%,.5)}.switch input{position:absolute;opacity:0;cursor:pointer}.switch div{width:1em;background:#646464;transition:.1s}.switch input:checked+div{transform:translate3d(100%,0,0);background:#eee}nav{display:flex;flex-direction:column;gap:6px}.inner_panel{display:flex;flex-direction:column;gap:6px;padding:4px;width:100%;margin-left:4px}.tab_button{display:flex;width:48px;height:48px;justify-content:center;align-items:center;border-radius:4px;border:none;transition:.1s cubic-bezier(.4, 0, .2, 1)}.preset-panel{display:flex;flex-wrap:wrap;gap:6px}.button{color:#eee;border:none;border-radius:4px;padding:6px 12px;cursor:pointer;transition:background .2s}.button:hover{background:hsla(0,0%,30%,.5)}.tab_button.active,.tab_button:hover{background:hsla(0,0%,40%,.5)}#backdrop{position:fixed;top:0;left:0;width:100%;height:100%;background-color:rgba(0,0,0,.5);z-index:9;backdrop-filter:blur(5px);-webkit-backdrop-filter:blur(5px)}.watermark{position:fixed;top:8px;left:50%;transform:translateX(-50%)}.subheading{font-weight:600}.view-option{text-align:left;align-items:center;height:28px;display:flex}.custom-input{color:#eee;background:hsla(0,0%,10%,.7);border:1px solid hsla(0,0%,100%,.1);border-radius:4px;padding:6px;outline:0}.text-muted{color:#bbb}input::-webkit-inner-spin-button,input::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}input[type=number]{-moz-appearance:textfield}
    `;
